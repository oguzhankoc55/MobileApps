...
public final class RecyclerRowBinding implements ViewBinding {
  ...
  private RecyclerRowBinding(@NonNull LinearLayout rootView, @NonNull TextView recyclerView) {
  ...
  public static RecyclerRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView recyclerView = ViewBindings.findChildViewById(rootView, id);
      if (recyclerView == null) {
        break missingId;
      }

      return new RecyclerRowBinding((LinearLayout) rootView, recyclerView);
    }
